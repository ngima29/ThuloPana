...
<body>
     ...
     if ($_SESSION['role'] === "seller" || $_SESSION['role'] === "admin") {
          if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if (in_array($fileActualExtention, $allowed)) {
                         if ($fileError === 0) {
                              if ($fileSize < 5242880) {
                                   ...
                                   $query = "INSERT INTO book(`user_id`, `isbn`, `title`, `description`, `author`, `category`, `type`, `pages`, `price`, `image`, `published_year`, `uploaded_at`, `updated_at`) 
				                         VALUES(:userid, :isbn, :title, :descriptions, :author, :category, :types, :pages, :price, :images, :pubyear, now(), now())";
               ...
               $qry = "SELECT * FROM category ORDER BY `c_name` DESC";
               ...
               <div class="login">
                    <form class="login__card" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                         <div class="form__heading">
                              <h2 class="card__heading">Add Book To</h2>
                         ...
                         <div class="input__group">
                              ...
                              <input class="input-field" type="text" autofocus maxlength="25" name="isbn" placeholder="ISBN" required />
                         </div>
                         <div class="input__group">
                              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                              ...
                              <input class="input-field" type="text" maxlength="50" name="title" placeholder="Title" required />
                         </div>
                         <div class="input__group">
                              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                              ...
                              <textarea class="input-field" placeholder="Description" name="description" cols="5" rows="3"></textarea>
                         </div>
                         <div class="input__group">
                              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                         ...
                         <div class="input__group">
                              ...
                              <input class="input-field" type="text" maxlength="5" name="pages" placeholder="Pages" required />
                         </div>
                         <div class="input__group">
                              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                              ...
                              <input class="input-field" type="text" maxlength="10" name="price" placeholder="Price" required />
                         </div>
                         <div class="input__group">
                              <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                              ...
                              <input class="input-field" type="text" maxlength="4" name="publishedYear" placeholder="Published Year" required />
                         </div>
                         ...
                         <input type="submit" name="submit" class="btn btn-all register_btn" value="Add">
